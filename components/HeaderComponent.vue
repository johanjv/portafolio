<template>
    <div class=" items-center justify-center ">
        <div class="">
            <nav class="bg-navbar w-full flex relative justify-between items-center mx-auto px-8 h-20">

                <div class="flex items-center">
                    <a class="cursor-pointer">
                        <h3 class="text-2xl font-medium">JOHAN VILLAVICENCIO</h3>
                    </a>
                </div>

                <div class="items-center hidden space-x-8 lg:flex">
                    <a class="flex text-other hover:text-blue-500
                ...
                <div class="flex items-center space-x-5">
                    <a class="flex text-other
                        cursor-pointer transition-colors duration-300
                        font-semibold text-blue-600">
                        
                            <svg class="fill-current h-5 w-5 mr-2 mt-0.5 text-other" 
                                version="1.1" 
                                id="Layer_1" 
                                xmlns="http://www.w3.org/2000/svg" 
                                xmlns:xlink="http://www.w3.org/1999/xlink" 
                                x="0px" y="0px" viewBox="0 0 122.88 71.9"  xml:space="preserve">
                                    <g>
